                    ...
                    <CardContent>
                        <div className="grid md:grid-cols-2 gap-4">
                            {(videoLessons[activeTopic as keyof typeof videoLessons] || []).map((video, index) => (
                                <Card key={index} className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => setModalContent({ title: video.title, description: video.description })}>
                    ...
                    <CardContent>
                        <div className="grid md:grid-cols-2 gap-4">
                            {(readingResources[activeTopic as keyof typeof readingResources] || []).map((resource, index) => (
                                <Card key={index} className="hover:shadow-md transition-shadow" onClick={() => setModalContent({ title: resource.title, description: resource.description })}>
